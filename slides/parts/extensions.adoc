...
plantuml::schemas/lifecycle.puml[cdi-lifecycle, format=svg, width=95%, height=85%]

plantuml::schemas/lifecyclelegend.puml[cdi-lifecycle-legend, format=svg, width=230, height=40, role=pull-right]
