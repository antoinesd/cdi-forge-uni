...
plantuml::schemas/spi_type_metamodel.puml[format=svg, width=100%, height=95%]


[.topic.source]
== SPI dedicated to CDI meta-model

plantuml::schemas/spi_cdi_metamodel.puml[format=svg, width=100%]
...
plantuml::schemas/spi_entrypoints.puml[format=svg, width=100%, height=95%]


[.topic.source]
== SPI dedicated to extensions

plantuml::schemas/spi_extensions.puml[format=svg, width=100%, height=100%]
