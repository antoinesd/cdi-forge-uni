...
image::jbossforge.png[role="pull-right", width="250"]
...
plantuml::schemas/architecture_forgeee6.puml[format=svg, width=95%, height=95%]
...
plantuml::schemas/architecture_forgeee7.puml[format=svg, width=95%, height=95%]
